...
for(const elem of array){ // végig itárálunk az arrayan és minden objectum alapján peldányosítunke egy studentot
    const stundent = new Student(elem.name,elem.average,elem.comment,elem.bad)
    manager.add(stundent)
}